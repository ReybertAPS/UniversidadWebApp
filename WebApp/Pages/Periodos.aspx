<%@ Page Title="Periodos" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="Periodos.aspx.cs" Inherits="WebApp.Pages.Periodos" %>
        ...
        <ContentTemplate>
            <div class="container">
                ...
                <div class="container-fluid card">
                    ...
                    <div class="pt-4">
                        <div class="Scroll">
                            <asp:GridView ID="gvPeriodos" runat="server" AutoPostBack="true" AutoGenerateColumns="false" CssClass="table">
                                <Columns>
